...
# Use optimizations if available USING SERVERLESS
...
find_index(endpoint_name=VECTOR_SEARCH_ENDPOINT, index_name=destination_tables_config["vectorsearch_index_name"])
...
index.similarity_search(columns=["chunked_text", "chunk_id", "path"], query_text="Como realizar una solicitud de creación de un EDV?")
